    ...
    <>
      <section className='max-w-6xl mx-auto flex justify-center items-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          ...
          <button type='submit' className='w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm font-medium rounded shadow-md hover:bg-blue-700 transition duratio-150 ease-in-out hover:shadow-lg active:bg-blue-800'>
